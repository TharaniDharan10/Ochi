...
const Footer = () => {
  return (
    <div className="flex gap-4 w-full h-screen bg-zinc-900 p-20  font-['Founders Grotesk X-Condensed']">
      ...
      <div className="w-1/2">
        ...
        <div className="details  mt-[10vh] font-['Founders Grotesk X-Condensed'] text-2xl">
          {["Facebook", "Twitter", "Skype"].map((e, index) => (
            <a key={index} className="block" href="#">
              {e}
            </a>
          ))}
        </div>
